    <div class="container">
        <div class="row">
            ...
            <div class="col-md-9">
                <h2 class="text-white">Halaman Dashboard</h2>
                                    ...
                                    <tbody>
                                        @foreach ($selesai as $item)
                                            <tr>
                                                ...
                                                <td>{{ \Carbon\Carbon::parse($item->tanggal_diterima)->format('d m Y, H:i') }}
                                                </td>
                                                <td>{{ \Carbon\Carbon::parse($item->tanggal_diambil)->format('d m Y, H:i') }}
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
