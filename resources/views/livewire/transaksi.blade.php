        ...
        <div class="col-md-9">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                @foreach ($barang as $key => $item)
                                    <div class="input-group mb-2">
                                        <input wire:model="barang.{{ $key }}" type="text"
                                            class="form-control">
                                        <div class="input-group-prepend">
                                            <div wire:click="hapus_barang({{ $key }})"
                                                class="input-group-text pointer">x</div>
                                        </div>
                                    </div>
                                @endforeach
                    ...
                    <button wire:click="store" class="btn btn-outline-info btn-lg mt-3">SIMPAN</button>
                </div>
            </div>
        </div>
    </div>
